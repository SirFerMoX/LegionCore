# ![logo](https://github.com/user-attachments/assets/0c3c1625-aca8-4482-9f32-826670cfb893) TrinityCore: Legion (7.3.5_26972)
...
make pull requests to our [Github repository](https://github.com/SirFerMoX/LegionCore/pulls).
...
Detailed installation guides are available in the [wiki](https://trinitycore.info/) for
Windows, Linux and macOS.


## Reporting issues

Issues can be reported via the [Github issue tracker](https://github.com/SirFerMoX/LegionCore/labels/main).

Please take the time to review existing issues before submitting your own to
prevent duplicates.

In addition, incorrect or poorly formed
...
* [Discord](https://discord.com/invite/HPP3wNh)
